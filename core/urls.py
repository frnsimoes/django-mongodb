...
urlpatterns = [
    ...
    path('students/count', views.NumberOfStudentsListView.as_view(), name='number-students-list'),
    path('students/create', views.CreateStudent.as_view(), name='create-student'),
    path('students/search', views.SearchStudent.as_view(), name='search-student'),
